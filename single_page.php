...
<div class="wrapper">
    <div class="content">
            ...
            <div class="carousel">
                ...
                <div id="carousel" class="carousel_inner">
                    <div class="carousel_box img-model">
                        <img class="img-single-page" src="<?= $product[src] ?>" alt="model"></div>
                    <div class="carousel_box img-model">
                        <img class="img-single-page" src="<?= $product[src] ?>" alt="model"></div>
                    <div class="carousel_box img-model">
                        <img class="img-single-page" src="<?= $product[src] ?>" alt="model"></div>
        ...
        <section class="add-review">
            <form class="email-password" method="post" action="#">
        ...
        <section id="watch-review" class="watch-review">
