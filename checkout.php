      ...
      <div class="header-flex">
        ...
        <div class="header-right">
          <div class="cart-position">
            ...
            <div class="cart">
              <div class="goods">
                <img src="img/Layer_43.jpg" alt="thing">
                <div class="cart-text">
              ...
              <div class="goods">
                <img src="img/Layer_44.jpg" alt="thing">
                <div class="cart-text">
                  <p class="name-goods">Rebox Zane</p>
                  <div class="star">
                    <i class="fa fa-star"></i>
            ...
            <div class="check-or-guest">
              <div class="check">
                ...
                <form action="#">
                  <div class="margin-bottom-for-checkout">
                    <input type="radio" class="radio" name="a" value="guest" id="guest" checked><label
                      for="guest">checkout as&nbsp;guest</label></div>
                  
                  <input type="radio" class="radio" name="a" value="register" id="register"><label for="register">register</label>
                </form>
              ...
              <div class="registred">
                ...
                <form class="email-password" method="post">
                  ...
                  <input type="email" name="email" value="<?=$_COOKIE[login]?>" required>
                  <p>PASSWORD<sup>&#42;</sup></p>
                  <input type="password" name="password" value="<?=$_COOKIE[password]?>" required>
                  <p class="last-p"><sup>&#42;</sup>Required Fileds</p>
                  <div class="flex-special">
<!--                      <button class="log-in" name="log_in"> Log in </button>-->
                    <input  class="log-in" type="submit" name="log_in" value="Log in">
